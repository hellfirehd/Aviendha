...
[DependsOn(typeof(AviendhaBillingManagementBlazorWebAssemblyModule))]
public class AviendhaBillingManagementBlazorHostClientModule : AbpModule
{
    ...
    private void ConfigureRouter()
    {
        ...
        {
            options.AppAssembly = typeof(AviendhaBillingManagementBlazorHostClientModule).Assembly;
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("AviendhaBillingManagement");
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<AviendhaBillingManagementBlazorHostClientModule>();
        });
    }
}
