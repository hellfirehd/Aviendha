...
public record AppliedSurcharge(Guid Id, String Name, Decimal FixedAmount, Decimal PercentageRate, TaxTreatment TaxTreatment)
{
    ...
    public override String ToString() => $"{Name}: {FixedAmount:C} + {PercentageRate:P}";
}
