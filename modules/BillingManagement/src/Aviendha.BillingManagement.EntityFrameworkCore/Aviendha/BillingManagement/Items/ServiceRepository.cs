...
public class ServiceRepository(IDbContextProvider<IBillingDbContext> dbContextProvider)
    : EfCoreRepository<IBillingDbContext, Service, ItemId>(dbContextProvider),
    IServiceRepository,
