...
public class AviendhaMailingListManagementApplicationModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.AddAutoMapperObjectMapper<AviendhaMailingListManagementApplicationModule>();
        Configure<AbpAutoMapperOptions>(options =>
        {
            options.AddMaps<AviendhaMailingListManagementApplicationModule>(validate: true);
        });
    }
}
