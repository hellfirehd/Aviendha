...
#nullable restore
        ...
        public global::CPCA.Listmonk.Api.Models.Campaign_content_type? ContentType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::CPCA.Listmonk.Api.Models.Campaign_lists>? Lists { get; set; }
#nullable restore
#else
        public List<global::CPCA.Listmonk.Api.Models.Campaign_lists> Lists { get; set; }
#endif
...
#nullable restore
        ...
        public global::CPCA.Listmonk.Api.Models.Campaign_type? Type { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::CPCA.Listmonk.Api.Models.Campaign"/> and sets the default values.
        /// </summary>
        public Campaign()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::CPCA.Listmonk.Api.Models.Campaign"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::CPCA.Listmonk.Api.Models.Campaign CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::CPCA.Listmonk.Api.Models.Campaign();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "content_type", n => { ContentType = n.GetEnumValue<global::CPCA.Listmonk.Api.Models.Campaign_content_type>(); } },
                { "created_at", n => { CreatedAt = n.GetStringValue(); } },
                { "from_email", n => { FromEmail = n.GetStringValue(); } },
                { "id", n => { Id = n.GetIntValue(); } },
                { "lists", n => { Lists = n.GetCollectionOfObjectValues<global::CPCA.Listmonk.Api.Models.Campaign_lists>(global::CPCA.Listmonk.Api.Models.Campaign_lists.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "type", n => { Type = n.GetEnumValue<global::CPCA.Listmonk.Api.Models.Campaign_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::CPCA.Listmonk.Api.Models.Campaign_content_type>("content_type", ContentType);
            writer.WriteStringValue("created_at", CreatedAt);
            writer.WriteStringValue("from_email", FromEmail);
            writer.WriteIntValue("id", Id);
            writer.WriteCollectionOfObjectValues<global::CPCA.Listmonk.Api.Models.Campaign_lists>("lists", Lists);
            ...
            writer.WriteEnumValue<global::CPCA.Listmonk.Api.Models.Campaign_type>("type", Type);
