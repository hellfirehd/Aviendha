...
namespace CPCA.Listmonk.Api.Models
{
    ...
    public partial class SMTPSettings : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::CPCA.Listmonk.Api.Models.SMTPSettings_email_headers>? EmailHeaders { get; set; }
#nullable restore
#else
        public List<global::CPCA.Listmonk.Api.Models.SMTPSettings_email_headers> EmailHeaders { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::CPCA.Listmonk.Api.Models.SMTPSettings"/> and sets the default values.
        /// </summary>
        public SMTPSettings()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::CPCA.Listmonk.Api.Models.SMTPSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::CPCA.Listmonk.Api.Models.SMTPSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::CPCA.Listmonk.Api.Models.SMTPSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "email_headers", n => { EmailHeaders = n.GetCollectionOfObjectValues<global::CPCA.Listmonk.Api.Models.SMTPSettings_email_headers>(global::CPCA.Listmonk.Api.Models.SMTPSettings_email_headers.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::CPCA.Listmonk.Api.Models.SMTPSettings_email_headers>("email_headers", EmailHeaders);
