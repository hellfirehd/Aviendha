...
public class AviendhaStringExtensionsTests
{
    ...
    [InlineData(Line1, 1, false, "T" + AviendhaStringExtensions.DefaultEllipsis)]
    [InlineData(Line1, 50, false, Line1)]

    [InlineData(ShortMultiLine, 0, true, Line1)]
    [InlineData(LongMultiLine, 0, true, Line3)]

    [InlineData(ShortMultiLine, 1, true, "T" + AviendhaStringExtensions.DefaultEllipsis)]
    [InlineData(LongMultiLine, 10, true, "Lorem" + AviendhaStringExtensions.DefaultEllipsis)]

    [InlineData(ShortMultiLine, 50, true, Line1)]
    [InlineData(LongMultiLine, 50, true, "Lorem ipsum dolor sit amet, consectetur" + AviendhaStringExtensions.DefaultEllipsis)]
