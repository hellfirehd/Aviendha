...
namespace Aviendha.OpenIddict;

public static class OpenIddictExtensions
{
    public static void UseCertificates(this OpenIddictServerBuilder options, Action<AviendhaOpenIddictOptions> confiugre)
    {
        var opt = new AviendhaOpenIddictOptions();
