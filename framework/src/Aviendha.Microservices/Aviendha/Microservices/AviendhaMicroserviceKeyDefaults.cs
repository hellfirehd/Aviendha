...
public static class AviendhaMicroserviceKeyDefaults
{
    ...
    public const String DataProtectionKey = "Aviendha-Protection-Keys";
    public const String DistributedCacheKeyPrefix = "Aviendha:";
